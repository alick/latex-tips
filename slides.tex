    ...
    \item Overfull/Underfull |\hbox|/|\vbox|
      \begin{itemize}
        \item Unreasonable use of |\newline|
          \begin{itemize}
            \item Not for new paragraph. Use blank lines instead.
            \item Not commonly used for newline in paragraph. Let \TeX\ hyphen
              (|\-|, |\hyphenation|).
          \end{itemize}
        \item Adjust content
...
\begin{frame}[fragile]{More Debugging Tips}
  \begin{itemize}
...
\begin{frame}[fragile]\frametitle{More Figure Tips}
  \begin{itemize}
    \item Specify figure/table/minipage size
      \begin{itemize}
        \item
...
\begin{frame}[fragile]\frametitle{Math Formulas}
...
\begin{frame}[fragile]\frametitle{Long Math Formulas}
...
\begin{frame}[fragile]
  \frametitle{Common Bib Errors~\cite{biberrors}}
...
\begin{frame}[fragile]
  \frametitle{Common Bib Errors Continued}
      \begin{itemize}
        \item
          Month, pages
\begin{lstlisting}[style=wrong]
...
\pause
        \item
          DOI, URL
\begin{lstlisting}[style=wrong,breaklines=false]
...
\item
  Citations are \alert{not} text words: |in [1]| $\rightarrow$
  |in Author Foo's work [1]|
\end{itemize}
...
\begin{frame}[fragile]\frametitle{Fonts in Slides}
...
\begin{frame}[fragile]\frametitle{Slides with Code Snippets}
  \begin{itemize}
    \item |\verb+Lorem Lipsum+|, \env{verbatim}
    \item |\lstinline+Lorem Lipsum+|, \env{lstlisting}
    \item Fragile frames
...
\begin{itemize}
  \item Log is your friend while debugging.
\item
  Details matter for aesthetic and high quality documents.
\item
  Some work is tedious. Try to automate it!
\end{itemize}
\nocite{elements}
...
\begin{frame}
  ...
  \begin{itemize}
    ...
    \item How to ask?
      \begin{itemize}
        \item Describe your environment, setup
        \item Minimal Working Example (MWE)
      \end{itemize}
  \end{itemize}
\end{frame}
...
\begin{frame}
  ...
  \begin{itemize}
    ...
    \item Fedora: \url{http://fedoraproject.org/join-fedora}
  \end{itemize}
\end{frame}
